# Contributing to LDTTeam projects
...
- **Your environment** — the project and version you are using, and any other relevant context.
- **Logs** — attach any relevant log files or crash reports.
- **A minimal reproduction** — if possible, an example that isolates the issue. The simpler, the better.

Please search the existing issues in the relevant repository before opening a new one to avoid duplicates.
...
1. **You are proficient in the language and technologies used in this project.**
   AI-generated code is only acceptable if you are capable of writing equivalent code yourself. If you cannot reason about the code, you cannot responsibly submit it.
...
5. **You have read and understood all the code you are submitting.**
